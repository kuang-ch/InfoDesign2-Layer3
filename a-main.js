    ...
    , 'csv', ' header', () => {
        for (let row of table.rows) {
            let rowData = {
                ...
                peopleTotal: parseInt(row.get('Total')),
                perPerson: parseFloat(row.get('perPerson')),
                percentUnder18: parseFloat(row.get('percentageUnder18')),
                percentElderly: parseFloat(row.get('percentageElderly')),
                awards: parseInt(row.get('Awards')),
                apps: parseInt(row.get('Applications'))
            }
            console.log(rowData)
